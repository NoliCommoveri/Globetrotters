...
`stories-and-spirits` — are recommended on no country card until D-15 lands in slice 21.
...
step (slice 10). What remains is slices 12 to 21: the 106 prompts and 19 forms
...
- **9 focuses and 6 project types.** Each focus carries a blurb written to a 5th
  ...
  recommended on a country card until slice 21 writes them.
...
weeks 1–3 to 12 / 86 / 69 — 106 prompts still to write, and that is slices 15 to 19.
...
`LIBRARY_v3.md` §3's ten on-theme prompts per focus, and slices 15 to 20 reach
it.
...
layout editor. `LIBRARY_v3.md` needs twenty-seven, so slices 12 to 14 add nineteen layout
